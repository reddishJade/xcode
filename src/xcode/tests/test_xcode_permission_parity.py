...
class StructuredPermissionParityTests(unittest.TestCase):
    """固定 STEP A shadow parity 结果，避免后续 cutover 回归。"""

    def test_structured_file_tools_static_policy_shadow_parity(self) -> None:
        cases = (
        ...
        for case in cases:
            with self.subTest(case.name):
                ...
                self.assertEqual(result.decision, case.expected_legacy_decision)
                ...
                self.assertEqual(result.shadow_diff, case.expected_shadow_diff)
